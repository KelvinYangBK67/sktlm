...
112. S1M2 Round 1 and Round 2 are six-host parallel control-plane stages, justified by the accepted S1M1 core-host equivalence evidence. Round 1 maps worker counts 4, 8, 12, 16, 20, and 24 respectively to `core-01` through `core-06` for the same frozen Devanagari-continuous representative workload. Round 2 maps its six frozen workloads respectively to `core-01` through `core-06`, all at the machine-readable Round 1 winner. A single shared `s1m2-vm-01` role and sequential launch are obsolete and forbidden.
