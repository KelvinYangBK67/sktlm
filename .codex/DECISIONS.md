...
57. The next execution gate is six planned full-M0 replicas at 8 workers, mapping `core-01` through `core-06` to `rep01` through `rep06`. Planning does not authorize launch; exact run IDs and commands must be recorded and explicitly user-authorized before execution.
