...
from sktlm.data.representations.canonical import CanonicalSegment, RepresentedSegment, SUPPORTED_SCRIPTS
from sktlm.data.representations.spacing import SPACING_CONDITIONS, apply_spacing
from sktlm.data.transliterate.iast_devanagari import (
    CONSONANTS,
    INDEPENDENT_VOWELS,
    SIGNS,
    VIRAMA,
