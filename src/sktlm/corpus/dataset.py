...
from sktlm.representations.canonical import CanonicalSegment, RepresentedSegment
from sktlm.representations.script import RepresentationConfig, derive_representations
