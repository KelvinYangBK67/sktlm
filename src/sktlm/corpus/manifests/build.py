...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--report", type=Path, default=Path("reports/cleaning/corpus_manifest_summary.txt"))
...
def main() -> None:
    ...
    for info in gretil_files:
        ...
        add_row(rows, info, duplicate_status, duplicate_of, base_weight, duplicate_weight, final_weight, args.split_seed)
...
def add_row(
    ...
    """Append one CSV row."""
    document_id = make_document_id(info.source, info.relative)
    rows.append(
        {
