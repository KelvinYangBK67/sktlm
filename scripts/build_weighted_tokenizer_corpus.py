"""Create a weighted tokenizer training corpus from corpus_manifest.csv.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--report", type=Path, default=Path("data/_reports/weighted_tokenizer_corpus_summary.txt"))
