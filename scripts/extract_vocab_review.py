"""Extract suspicious or linguistically interesting vocab pieces for review."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--vocab", type=Path, default=Path("tokenizer/weighted_unigram_24000_danda_split.vocab"))
    parser.add_argument("--txt", type=Path, default=Path("data/_reports/vocab_review_weighted_unigram_24000_danda_split.txt"))
    parser.add_argument("--csv", type=Path, default=Path("data/_reports/vocab_review_weighted_unigram_24000_danda_split.csv"))
